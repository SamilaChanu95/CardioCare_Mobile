...
public class SampleBCConsultant extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        client.post("http://192.168.1.101/cardiocare_mobile/consultnt/getdbrowcount.php",params ,new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if(obj.getInt("count") != 0){
                        final Intent intnt = new Intent(context, MyServiceConsultant.class);
                        // Set unsynced count in intent data
                        intnt.putExtra("intntdata", "There are "+obj.getInt("count") + " unsynced Consultant Details");
                        // Call MyService
